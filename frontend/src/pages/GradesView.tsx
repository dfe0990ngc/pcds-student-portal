...
export default function GradesView({ grades, student }: GradesViewProps) {
  const handleExportPDF = () => {
    const printContent = document.getElementById('grades-content');
      ...
      <html>
        <head>
          ...
          <style>
            ...
            h1 {
              color: #008ea2;
              border-bottom: 3px solid #008ea2;
              padding-bottom: 10px;
              margin-bottom: 30px;
            }
            h2 {
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="grades-content">
        <h1 style={{ color: '#008ea2', fontSize: '28px', marginBottom: '20px' }}>Student Grades Report</h1>
        ...
        <div className="bg-white shadow-sm mb-6 p-6 rounded-xl">
          <div className="flex justify-between gap-6">
            ...
            <button
              ...
              className="flex items-center space-x-2 hover:opacity-90 shadow-sm px-4 py-2 rounded-sm h-8 font-medium text-white transition-all"
        ...
        <div className="bg-white shadow-sm mb-6 p-6 rounded-xl">
          ...
          <div className="space-y-4">
            {grades.map((grade) => (
              <div key={grade.GradeID} className="hover:shadow-md p-4 border border-gray-200 rounded-lg transition-shadow">
        ...
        <div className="bg-white shadow-sm p-6 border-2 rounded-xl" style={{ borderColor: '#008ea2' }}>
