...
export default function AccountView({ account }: AccountViewProps) {
  const handleExportPDF = () => {
    const printContent = document.getElementById('account-content');
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Student Account Statement</title>
          <style>
            body {
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="account-content">
        <h1 style={{ color: '#008ea2', fontSize: '28px', marginBottom: '20px' }}>Student Account Statement</h1>
